...
{/* The `USDC` Scenarios tab models three rate paths — flat, −100bps, and −200bps — against three sharing-rate scenarios, producing a 3×3 matrix of FY2026 and FY2027 outcomes. The range across all nine cells: \$$570$M to \$$1,480$M. */}

{/* That's a \$$910$M spread on a single revenue line. */}
