...
The first: a \$$718$M unrealized loss on Coinbase's corporate crypto portfolio. As of December 31, 2025, Coinbase held $15,389$ `BTC` (approx. \$$1.34$B at year-end market prices of \$$87{,}000$/BTC) and $151,175$ `ETH` (approx. \$$297$M). Both declined meaningfully during Q4, producing a \$$718$M markdown that flowed directly to the GAAP income statement. No cash changed hands. No position was sold. The loss is purely the output of fair-value accounting applied to assets Coinbase continues to hold.
