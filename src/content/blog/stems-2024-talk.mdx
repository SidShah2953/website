...
description: "Notes from an introductory session on Options at STEMS 2024 Camp (CMI). Covers fundamental ideas of Financial Mathematics and explains the structure of options."
tags: ["Finance", "Math", "Options"]
isHidden: false
ogImage: /og/stems-2024-talk.png
thesis: | 
    The value of an option lies in the fact that you are not obligated to exercise it. If you are able to sell an asset at a higher price, or if you are able to buy it for a lower price, you can let the contract expire, and your downside is limited to the price of the contract.
---
...
- Consider a situation where you are uncertain about the price of a good you are selling.
    ...
    You need to sell each unit for a minimum of $\operatorname{Rs.} 40$ to cover your costs, and you need to sell at least $100$ units by the end of the month. You find someone who is willing to accept this deal, if you decide to execute it, but they ask for $\operatorname{Rs.}10$ to give you this <T k="derivatives">option</T>.
...
- Now consider the opposite situation, where you are uncertain about the quantity of a good you will need a month from now.
    ...
    You need to at least $100$ units by the end of the month, and you are willing to pay $\operatorname{Rs.}40$ for each unit. You find someone who is willing to accept this deal, if you decide to execute it, but they ask for $\operatorname{Rs.}10$ to give you this <T k="derivatives">option</T>.
...
- **Call <T k="derivatives">Option</T>:** A type of option contract that allows the holder to buy an asset at a specified price, known as the **strike price**, on a specified future date, known as the **expiration date**. The holder is not obligated to buy the asset; they have the right to do so.
