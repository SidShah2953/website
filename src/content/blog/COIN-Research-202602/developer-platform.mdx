---
title: "Coinbase's Invisible Business: The Developer Platform That 270 Enterprises Are Already Using"
publishedAt: 2026-03-02
description: "The CDP, Institutional Infrastructure, and the AWS Parallel Nobody Is Quantifying"
tags: ["Crypto", "Finance"]
isHidden: false
articleNumber: 6
thesis: |
...
Every dollar of CDP revenue is buried inside either "Other Transaction" (\$$252.9$M, +$20\%$ YoY in FY2025) or "Other Sub & Services" (\$$554.8$M, +$30\%$ YoY). Neither line has a sub-breakout in any public filing. The models I've come across have no sub-model for either.
...
FY2025 trading volume: \$$5.2$T, up $156\%$ YoY — including institutional activity routed through Coinbase Prime and the CDP. Total assets on platform: \$$516$B as of Q3 2025. Monthly transacting users: $9.2$M. Coinbase's share of total crypto trading volume doubled to $6.4\%$.

At institutional custody fee rates of $0.5$–$1.5$bps applied to \$$516$B in platform assets, implied custody fee revenue alone ranges from \$$258$M to \$$774$M annually — a range that substantially overlaps with the combined catch-all lines. Even the low end of that range would make the CDP the second-largest revenue segment in the business. The disclosed custodial fee revenue line (\$$198.2$M, +$40\%$ YoY in FY2025) is almost certainly a partial view of total custody economics — likely excluding API and platform access revenue classified elsewhere.



## The AWS Analogy: Taking It Seriously

AWS captured approximately \$$25$B in revenue by FY2019 — roughly $12\%$ of Amazon's total — before achieving the market recognition that drove Amazon's multiple expansion. At \$$7.2$B in Coinbase total revenue, a business at $12\%$ revenue share implies approximately \$$860$M in CDP revenue. That figure is within the plausible range of the catch-all lines.
