...
Departure means that beginning Q2 2026, Coinbase retains 100% of sequencer fees. The Optimism Protocol share is eliminated. At $75.4M gross sequencer revenue and a 12% share, the departure eliminates ~$9M in annual cost at current run-rates — and eliminates it as a percentage of a growing line. If Base reaches $100M in gross sequencer revenue in FY2026 (conservative given the current daily run-rate), the OP departure saves ~$12M versus the prior structure.
...
The Multiple Periods tab in the attached model includes analyst FY2026E net sequencer revenue of ~$50M and FY2027E of ~$65M. Deliberately conservative: partial-year OP departure benefit (Q2–Q4 only), cautious growth assumptions that don't extrapolate the 30x FY2025 trajectory.
