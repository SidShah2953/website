...
# Deep Research Article 5: Why Coinbase Reported a $667 Million Loss Last Quarter — Style Pass

# *Why Coinbase Reported a $667 Million Loss Last Quarter — And Why It Doesn't Mean What You Think*
...
Two fair-value items drove the ($667M) GAAP net loss.

The first: a $718M unrealized loss on Coinbase's corporate crypto portfolio. As of December 31, 2025, Coinbase held 15,389 Bitcoin (~$1.01B at year-end market prices) and 151,175 Ethereum (~$297M). Both declined meaningfully during Q4, producing a $718M markdown that flowed directly to the GAAP income statement. No cash changed hands. No position was sold. The loss is purely the output of fair-value accounting applied to assets Coinbase continues to hold.

The second: a $395M fair-value markdown on Coinbase's equity stake in Circle. As Circle pursues its IPO, its pre-IPO valuation has been adjusted downward based on the most recent observable transaction prices available.

Combined: $1,113M of non-cash accounting entries. The operating business, meanwhile, generated $3,193.7M in Adjusted EBITDA for the full year — a 44.4% margin on $7.2B in revenue.
...
The math is mechanical: a 10% Bitcoin price decline from one quarter-end to the next produces approximately $101M in additional GAAP expense, entirely independent of the operating business. A 10% increase produces approximately $101M in GAAP income. GAAP EPS for Coinbase is now structurally a hybrid metric: part operating earnings, part crypto mark-to-market.
...
Total crypto portfolio value as of December 31, 2025: approximately $2.0B. Combined with $11.3B in cash and cash equivalents, total liquid resources were approximately $14.1B — balance sheet flexibility that absorbs multiple quarters of paper losses without any operational constraint.
...
The Circle equity stake ($395M markdown in Q4 2025) will be a recurring item until Circle's IPO closes and the stake is either sold or repriced to a public market value. Watch Circle's IPO timeline.
