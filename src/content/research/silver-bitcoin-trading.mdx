...
publication: "Technical Analysis of Stocks & Commodities 43(6): 20–22, 47, June 2025"
tags:
  - "Cryptocurrency"
  - "Bitcoin"
  - "Silver"
...
Buy-and-hold of bitcoin is hard to achieve for many reasons, so a trading system may help. Here's a look at a simple trading strategy for bitcoin that references overnight silver returns to predict bitcoin 24-hour close-to-close returns. Find out how this strategy fared in a 10-year <T k="systematic-trading">backtest</T>.
...
- **Annualized Returns**: 68.65% over 10-year <T k="systematic-trading">backtest</T> period
...
The strategy was <T k="systematic-trading">backtested</T> on 10 years of historical data, incorporating:
