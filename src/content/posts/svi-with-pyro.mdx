...
<img src="../src/media/posts/svi-with-pyro/Image01-PreliminaryVisualisation.png"></img>
---
...
```
<img src="../src/media/posts/svi-with-pyro/Image02-CustomGuideParams.png"></img>
...
pyro.render_model(auto_guide,
                  ...
                  render_params=True)
```
<img src="../src/media/posts/svi-with-pyro/Image03-AutoGuideParams.png"></img>
...
```
<img src="../src/media/posts/svi-with-pyro/Image04-SVIStep.png" width="80%" class='self-center'></img>
...
plt.show()
```
<img src="../src/media/posts/svi-with-pyro/Image05-DensityVsSlope.png"></img>
...
```
<img src="../src/media/posts/svi-with-pyro/Image06-PosteriorDistribution.png"></img>
