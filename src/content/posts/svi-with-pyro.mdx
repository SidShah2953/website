...
![Preliminary Visualisation](/src/assets/posts/svi-with-pyro/Image01-PrelimVisual.png)
---
...
```
![Custom Guide Parameters](/src/assets/posts/svi-with-pyro/Image02-CustomGuideParams.png)
...
pyro.render_model(auto_guide,
                  ...
                  render_params=True)
```
![AutoGuide Parameters](/src/assets/posts/svi-with-pyro/Image03-AutoGuideParams.png)
...
<div class="self-center">
    ![SVI Steps](/src/assets/posts/svi-with-pyro/Image04-SVIStep.png)
</div>
...
plt.show()
```
![Density Vs Slope](/src/assets/posts/svi-with-pyro/Image05-DensityVsSlope.png)
...
```
![Posterior Distribution](/src/assets/posts/svi-with-pyro/Image06-PosteriorDistribution.png)
